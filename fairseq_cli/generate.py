...
def _main(args, output_file):
    ...
    for sample in progress:
        ...
        #
        # src_str1 = src_dict.string(src_tokens, args.remove_bpe)
        # src_str1 = decode_fn(src_str1)
        # print(src_str1)
        #
        # # src_tokens = generator.pars2tags(src_dict, src_tokens)
        # # src_str2 = src_dict.string(src_tokens, args.remove_bpe)
        # # src_str2 = decode_fn(src_str2)
        # # print(src_str2)
        # exit()
        ...
        for i, sample_id in enumerate(sample['id'].tolist()):
            ...
            for j, hypo in enumerate(hypos[i][:args.nbest]):
                ...
                if has_target and j == 0:
                    ...
                    # target_str_noseg = [target_str]
                    # detok_hypo_str_noseg = [detok_hypo_str]
