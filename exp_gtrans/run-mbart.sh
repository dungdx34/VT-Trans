...
if [ $mode == "train" ]; then
  ...
  python train.py $bin_path --save-dir $cp_path --tensorboard-logdir $cp_path --seed 222 --num-workers 2 \
         ...
         --max-tokens 1500 --update-freq 2 --validate-interval 1 --patience 5 --no-epoch-checkpoints \
